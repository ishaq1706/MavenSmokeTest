...
private WebDriver driver;
	...
	public WebDriver openBrowser(String sBrowserType) throws MalformedURLException{
	...
	if (sBrowserType.equalsIgnoreCase("Chrome")){
		...
		File Firefoxdriver = new File("C:\\Users\\ishaq\\Downloads\\geckodriver-v0.17.0-win32\\geckodriver.exe");
